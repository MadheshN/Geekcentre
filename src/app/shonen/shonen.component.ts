...
@Component({
  ...
  styleUrls: ['./shonen.component.css']
})
export class ShonenComponent implements OnInit {
  ...
  quote:string= " “ If you don’t like the hand that fate’s dealt you with , fight for a new one. ”  -  Naruto Uzumaki  |  Naruto Shippuden ( 2012 )";
  constructor(private db:DbService,private service:DbService,private http:HttpClient,private route:Router) {
    this.db.getshonen().subscribe(data=>{this.shonen=data;});
